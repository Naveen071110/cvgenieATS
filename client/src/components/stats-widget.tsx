...
export function StatsWidget({
  ...
  return (
    <div className={cn("stats-widget fade-in-up", className)}>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="stat text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/15 transition-all duration-300 fade-in-up"
