    ...
    <div className={cn('trust-badges', className)}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-center max-w-4xl mx-auto">
        {trustBadges.map((badge, index) => (
          ...
          >
            <div className="flex flex-col items-center p-4 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-primary/30 dark:hover:border-primary/50 hover:shadow-md transition-all duration-300 cursor-pointer">
              <div className="flex items-center justify-center w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-lg mb-3 text-primary dark:text-blue-400 group-hover:bg-primary/20 dark:group-hover:bg-primary/30 transition-colors">
                {badge.icon}
              </div>
